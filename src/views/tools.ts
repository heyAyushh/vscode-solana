...
// export const registerToolsView = () => {
  // const rootPath = (vscode.workspace.workspaceFolders && (vscode.workspace.workspaceFolders.length > 0))
    // ? vscode.workspace.workspaceFolders[0].uri.fsPath : undefined;

  // if (rootPath) {
    // const testsProvider = new TestsProvider(rootPath);
    // vscode.window.registerTreeDataProvider('solana-view-tools', testsProvider);
    // vscode.commands.registerCommand('solana-view-tools.refreshEntry', () => testsProvider.refresh());
    // vscode.commands.registerCommand('solana-view-tools.test', () => vscode.commands.executeCommand(`solana.tools`));
    // vscode.commands.registerCommand(
    //   'solana-view-tools.skipLocalValidator',
    //   () => vscode.commands.executeCommand(`solana.testAgainstLocalValidator`)
    // );
    // vscode.commands.registerCommand('solana-view-tools.editEntry', (fileName: string) => vscode.commands.executeCommand('vscode.open', vscode.Uri.joinPath(vscode.workspace.workspaceFolders[0].uri, 'tests', fileName)));
